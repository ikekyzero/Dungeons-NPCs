...
namespace UnityEngine.UI
{
    ...
    public class AutoExpandGridLayoutGroup : LayoutGroup
    {
        ...
        [SerializeField]
        protected bool m_UseSquareCells = true;
        public bool useSquareCells { get { return m_UseSquareCells; } set { SetProperty(ref m_UseSquareCells, value); } }
        ...
        private void SetCellsAlongAxis(int axis)
        {
            ...
            float cellSizeX = ((width - (spacing[0] * (actualCellCountX - 1))) / actualCellCountX);
            float cellSizeY = m_UseSquareCells ? cellSizeX : ((height - (spacing[1] * (actualCellCountY - 1))) / actualCellCountY);
            ...
            for (int i = 0; i < rectChildren.Count; i++)
            {
                ...
                SetChildAlongAxis(rectChildren[i], 0, startOffset.x + (cellSizeX + spacing[0]) * positionX, cellSizeX);
                SetChildAlongAxis(rectChildren[i], 1, startOffset.y + (cellSizeY + spacing[1]) * positionY, cellSizeY);
            }
        }
    }
}